    ...
    return (
      <DashboardLayout>
        <div className="text-center py-12">
          ...
          <p className="text-slate-600 mb-4">You need to be signed in to access risk management.</p>
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-800">Create New Assessment</h3>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-800">View Assessments</h3>
            </div>
            <p className="text-slate-600 mb-4">
        ...
        {/* Features Overview */}
        <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-800 mb-6">Risk Assessment Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Identify Hazards</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Assess Risk</h3>
              <p className="text-slate-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Control Risks</h3>
              <p className="text-slate-600 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200 text-center">
            <div className="text-3xl font-bold text-indigo-600 mb-2">5-Step</div>
            <div className="text-slate-600">Assessment Process</div>
          </div>
          
          <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200 text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">Auto</div>
            <div className="text-slate-600">Risk Calculation</div>
          </div>
          
          <div className="bg-white rounded-xl shadow-lg p-6 border border-slate-200 text-center">
            <div className="text-3xl font-bold text-blue-600 mb-2">PDF</div>
            <div className="text-slate-600">Export Reports</div>
          </div>
        </div>
      </div>
    </DashboardLayout>
