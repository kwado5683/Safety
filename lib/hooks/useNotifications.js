...
export const useNotificationTemplates = () => {
  ...
  const showIncidentNotification = useCallback((incidentData) => {
    return showNotification('incident', {
      options: {
  ...
  const showActionNotification = useCallback((actionData) => {
  ...
  const showInspectionNotification = useCallback((inspectionData) => {
    return showNotification('inspection', {
      options: {
  ...
  const showTrainingNotification = useCallback((trainingData) => {
    return showNotification('training', {
      options: {
  ...
  const showSystemNotification = useCallback((systemData) => {
    return showNotification('system', {
      options: {
